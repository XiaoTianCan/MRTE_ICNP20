...
# ridNumList = [10, 11, 12, 13, 14, 15]
# res = []
# totalNodeNum = 0
# for _ in range(16):
#     rint = random.randint(0, 5)
#     res.append(rint)
#     totalNodeNum += ridNumList[rint]
# print(res)
# print(totalNodeNum)
# exit()
...
regionNum = 16
ridNumList = [10, 11, 12, 13, 14, 15]
ridList = [1, 5, 4, 0, 3, 2, 4, 4, 1, 3, 0, 4, 2, 3, 5, 3]
nodeNumList = [ridNumList[rid] for rid in ridList]
aveNode = 12
NL = 2
## grid
regionLinkSet = [
...
for rid in range(regionNum):
    orid = ridList[rid]
    filein = open("./res/topo_n%d_m%d_r%d.txt" % (aveNode, NL, orid))
